...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        Apinterface myApi = retrofit.create(Apinterface.class);
        Call<List<Produit>> call = myApi.Affichage();
        call.enqueue(new Callback<List<Produit>>() {
            @Override
            public void onResponse(Call<List<Produit>> call,
            ...
            @Override
            public void onFailure(Call<List<Produit>> call, Throwable
            t) {
